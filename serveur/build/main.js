...
restRouter.use('/user', _user.userRoute);
...
var _mongoosePaginate = __webpack_require__(4);
...
articleModel.plugin(_mongoosePaginate2.default);
...
var _userRoute = __webpack_require__(17);

Object.defineProperty(exports, 'userRoute', {
  enumerable: true,
  get: function get() {
    return _userRoute.userRoute;
  }
});
...
var userRoute = exports.userRoute = _express2.default.Router();
//import passport from 'passport'


userRoute.post('/signup', _user2.default.signup);
userRoute.post('/login', _user2.default.login);
userRoute.route('/').get(_user2.default.findAll);
userRoute.route('/:id').get(_user2.default.findOne).put(_user2.default.update).delete(_user2.default.delete);
...
exports.default = {
    signup: function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
            var _userService$validate, value, error, encryptedPass, user;
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _userService$validate = _user2.default.validateSignup(req.body), value = _userService$validate.value, error = _userService$validate.error;
                        ...
                        case 4:
                            encryptedPass = _user2.default.encryptedPass(value.password);
                            _context.next = 7;
                        ...
                        case 7:
                            user = _context.sent;
                            return _context.abrupt('return', res.redirect('http://localhost:3000/login'));
    ...
    login: function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
            var _userService$validate2, value, error, user, authenticated;
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            _userService$validate2 = _user2.default.validateLogin(req.body), value = _userService$validate2.value, error = _userService$validate2.error;
                        ...
                        case 4:
                            _context2.next = 6;
                            return _userModel2.default.findOne({ email: value.email });
                        ...
                        case 9:
                            ;
                            authenticated = _user2.default.comparePassword(value.password, user.password);
                        ...
                        case 13:
                            return _context2.abrupt('return', res.redirect('http://localhost:3000/new_article'));
    ...
    findAll: function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(req, res) {
            var _req$query, page, perpage, options, user;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 5;
                            return _userModel2.default.paginate({}, options);
    ...
    update: function () {
        var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(req, res) {
            var id, schema, _Joi$validate, value, error, user;
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 6:
                            _context5.next = 8;
                            return _userModel2.default.findByIdAndUpdate({
                                _id: id
                            }, value, {
                                new: true
                            });
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            ...
                            id = req.params.id;
                            _context6.next = 4;
                            return _userModel2.default.findByIdAndRemove({
                                _id: id
                            });
